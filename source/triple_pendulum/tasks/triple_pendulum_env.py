# Isaac Lab DirectRLEnv for the triple inverted pendulum on a cart
# obs: [x, x_dot, theta1, theta1_dot, theta2, theta2_dot, theta3, theta3_dot]
# action: cart force in [-1, 1] scaled to +/-action_scale N
...
class TriplePendulumEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: TriplePendulumEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        # pre-allocate observation cache (reused in _get_rewards / _get_dones)
    ...
    def _apply_action(self) -> None:
        efforts = self.cfg.action_scale * self.actions
